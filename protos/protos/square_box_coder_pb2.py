...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.square_box_coder_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _SQUAREBOXCODER._serialized_start=41
  _SQUAREBOXCODER._serialized_end=124
